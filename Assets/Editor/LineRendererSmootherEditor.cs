...
public class LineRendererSmootherEditor : Editor
{
    ...
    private GUIContent UpdateInitialStateGUIContent = new GUIContent("Set Intial State");
    ...
    private void OnEnable()
    {
        ...
        SmoothingSections = serializedObject.FindProperty("SmoothingSecions");
    ...
    private void OnSceneGUI()
    {
        ...
        for(int i = 0; i < Curves.Length; ++i)
        {
            ...
            Vector3 lastDiection = (position - lastPosition).normalized;
            Vector3 nextDirection = (position - nextPosition).normalized;

            Vector3 startTangent = (lastDiection + nextDirection) * SmoothingLength.floatValue;
            Vector3 endTangent = (nextDirection + lastDiection) * -1 * SmoothingLength.floatValue;
